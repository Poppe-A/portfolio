...
export default function Contact() {
  ...
  return (
    <div className='w-full flex flex-col justify-between items-center flex-grow text-white pt-32'>
      <div className='text-3xl md:text-6xl border-2 md:border-4 border-green-600 p-2 md:p-6'>
        <span className='text-green-600'>M</span>e contacter
      </div>
